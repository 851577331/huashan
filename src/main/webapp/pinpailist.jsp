...
%>
  <head>
    <title>${requestScope.billboard.btitle}</title>
    
	<meta http-equiv="pragma" content="no-cache">
	<meta http-equiv="cache-control" content="no-cache">
	<meta http-equiv="expires" content="0">    
	<meta http-equiv="keywords" content="${requestScope.billboard.bkeywords}">
	<meta http-equiv="description" content="${requestScope.billboard.bdescription}">
...
<body>
		...
		<div class="header1 wapper">
			<h1>
				<a href="http://www.zhongtaojiaju.com/"> <img
					src="http://www.zhongtaojiaju.com/upload/image/20180703/201807030945298715.jpg"
					alt="中国陶瓷十大品牌中心_中陶家居网" style="float:left;" /> </a>
			</h1>
		</div>
		<div class="daohangbg">
		...
		<div class="pinpailist">
			<div class="con3 wapper">
				<div class="c3_left">
					<h2 align="center" style="color:red;">${requestScope.billboard.pname}</h2>
					<c:forEach items="${Brand}" var="b">
					<dl>
						<dt>
							<a href="${APP_PATH}/pinpaidetail/${b.pid}" target="_blank"> <img
								src="${APP_PATH}/${b.img}"
								alt="${b.alt}" /> </a>
						</dt>
						<dd>
							<strong><a href="${APP_PATH}/pinpaidetail/${b.pid}" target="_blank"
								title="${b.title1}">${b.title}</a> </strong>
								<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${b.miaoshu}</span>
							<b><a href="${APP_PATH}/pinpaidetail/${b.pid}" target="_blank" rel="nofollow">查看更多</a>
							</b>
						</dd>
					</dl>
					<div class="clear"></div>
				...
				<c:forEach items="${B}" var="p">
					<li>
						<div class="img">
							<table>
								<tr>
									<td><a href="${APP_PATH}/pinpaidetail/${p.pid}"><img src="${APP_PATH}/${p.img}" height="95" width="265"  alt="${p.alt}"/>
									</a></td>
								</tr>
							</table>
						</div> <a href=""><span>${p.title1}</span></a>
					</li>
					</c:forEach>
				</ul>
			</div>
