                            ...
                            <div class="card alert">
                                ...
                                <div class="card-body">
                                    <div class="horizontal-form">
                                        <form action="${APP_PATH}/admin/addpin" class="form-horizontal" method="post" enctype="multipart/form-data">
                                            ...
                                            <div style="display:none" class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" value="${requestScope.byid}" name="yid" >
                                                </div> 
                                            </div>
                                          	<div class="form-group">
                                                        ...
                                                        <c:forEach items="${Byidlist}" var="b">
                                                            <option value ="${b.bid }">${b.pname}</option>
                                                        </c:forEach>
                                                        </select>
                                                        </div>
                                             </div> 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="alt" placeholder="此项SEO填写">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea class="form-control" id="editor_id" rows="3" name="miaoshu" required></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">标题</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="title1" placeholder="此项SEO填写">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">伪标题</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="weit" placeholder="此项SEO填写">
                                                </div>
                                            </div>                                 
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">关键词</label>
                                                <div class="col-sm-10">
                                                    <textarea class="form-control" rows="3" name="keywords" placeholder="此项SEO填写"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">描述</label>
                                                <div class="col-sm-10">
                                                    <textarea class="form-control" rows="3" name="description" placeholder="此项SEO填写"></textarea>
                                                </div>
                                            </div>                                    
                                            <div class="form-group">
