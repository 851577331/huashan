                            ...
                            <div class="card alert">
                                ...
                                <div class="card-body">
									<div class="menu-upload-form">
										<form class="form-horizontal" action="${APP_PATH }/admin/update/${requestScope.user.id}" method="post">
										<div class="form-group">
                                            <label class="col-sm-2 control-label">ID</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="id" value="${requestScope.user.id}" class="form-control" placeholder="Id"  disabled>
                                            </div>
                                        </div>  
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">User</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="uname" value="${requestScope.user.uname}" class="form-control" placeholder="User" required>
                                            </div>
                                        </div>                      
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">password</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="password" value="${requestScope.user.password}" class="form-control" placeholder="password" required>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
                                                <button type="submit" onclick="return confirm('你确定更新？')" class="btn btn-lg btn-primary">修改</button>
                                            </div>
                                        </div>
                                    </form>
									</div>
