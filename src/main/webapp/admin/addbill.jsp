                            ...
                            <div class="card alert">
                                ...
                                <div class="card-body">
									<div class="menu-upload-form">
										<form class="form-horizontal" action="addb" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="byid" class="form-control"  required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">标题</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="btitle" class="form-control" placeholder="此项SEO填写">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">描述</label>
                                            <div class="col-sm-6">
                                                <textarea class="form-control" rows="3" name="bdescription" placeholder="此项SEO填写"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">关键词</label>
                                            <div class="col-sm-6">
                                                <textarea class="form-control" rows="3" name="bkeywords" placeholder="此项SEO填写"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
