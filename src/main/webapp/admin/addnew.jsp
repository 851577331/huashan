                            ...
                            <div class="card alert">
                                ...
                                <div class="card-body">
									<div class="menu-upload-form">
										<form id="person" method="post" action="${APP_PATH}/admin/addnew" enctype="multipart/form-data">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" name="weit" class="form-control"  required>
                                            </div>
                                            ...
                                            <div class="col-sm-12">
                                                <textarea class="form-control" rows="3" name="nkeyword" ></textarea>
                                            </div>
                                            <label class="col-sm-2 control-label">描述</label>
                                            <div class="col-sm-12">
                                                <textarea class="form-control" rows="3" name="ndescribe" ></textarea>
                                            </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">文章内容</label>
                                            <div class="col-sm-12">
                                          <textarea name="myEditor" id="myEditor" rows="8" style="height: 350px; width: 99%;"></textarea>
                                            </div>
                                        </div>  
                                        <div class="form-group">
